...
\newcommand{\refig}[1]{図\ref{label::figure::#1}}
\newcommand{\refeq}[1]{式（\ref{label::equation::#1}）}
\newcommand{\reftab}[1]{表\ref{label::table::#1}}

\newcommand{\labeledfigure}[4] {
  \begin{figure}[#1]
    \begin{center}
      \includegraphics[width=#2\hsize]{#3}
    \end{center}
    \caption{#4}
    \label{label::figure::#3}
  \end{figure}
}
...
\def\@@eq#1#2{\begin{equation}#2\label{label::equation::#1}\end{equation}}
\makeatother
