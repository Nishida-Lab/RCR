...
if("TRUE" STREQUAL "TRUE")
  set(message_runtime_SOURCE_PREFIX /home/pi/RCR/2018/ros_catkin_ws/src/message_runtime)
  set(message_runtime_DEVEL_PREFIX /home/pi/RCR/2018/ros_catkin_ws/devel_isolated/message_runtime)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/RCR/2018/ros_catkin_ws/src/message_runtime/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/RCR/2018/ros_catkin_ws/devel_isolated/message_runtime/lib;/opt/ros/kinetic/lib)
