# Install script for directory: /home/pi/RCR/Raspberry-Pi/LIB/OpenCV/userland/containers/rtp
...
FILE(INSTALL DESTINATION "/opt/vc/lib/plugins" TYPE SHARED_LIBRARY FILES "/home/pi/RCR/Raspberry-Pi/LIB/OpenCV/userland/build/lib/reader_rtp.so")
  IF(EXISTS "$ENV{DESTDIR}/opt/vc/lib/plugins/reader_rtp.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/opt/vc/lib/plugins/reader_rtp.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/opt/vc/lib/plugins/reader_rtp.so")
